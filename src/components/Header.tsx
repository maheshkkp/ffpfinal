    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <a href="#" className="flex items-center">
          <Feather className="mr-2 text-amber-800" size={32} />
          <span className={`text-xl font-semibold font-serif ${isScrolled ? 'text-amber-800' : 'text-white'}`}>
            French Finish Pro
          </span>
        </a>
        ...
        <div className="fixed inset-0 z-40 w-full h-full bg-white">
          <div className="container py-4">
            <div className="flex items-center justify-between">
              <a href="#" className="flex items-center">
                <Feather className="mr-2 text-amber-800" size={32} />
                <span className="text-xl font-semibold text-amber-800 font-serif">French Finish Pro</span>
              </a>
